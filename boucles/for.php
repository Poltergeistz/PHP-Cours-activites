...
foreach($college as $array => $value){
  if(is_array($value)){
...
$college['Troisième'] = array(
  array('Nom' => 'Chirac', 'Prenom' => 'Patrick'),
  array('Nom' => 'Leponge', 'Prenom' => 'Bob'),
  array('Nom' => 'Kelso', 'Prenom' => 'Bob')
);
foreach($college as $array => $value){
  if(is_array($value)){
    foreach($value as $key){
...
$videotheque[] = array(
    ...
    'acteurs' => array(
    'Elijah Wood','Ian McKellen','Vigo Mortensen','Liv Tyler','Sean Astin','Cate Blanchett'
    ));
$videotheque[] = array(
...
$videotheque[] = array(
    ...
    'acteurs' => array(
    'Jeff Bridges','John Goodman','Steve Buscemi','Julianne Moore','David Huddleston',
    ));
